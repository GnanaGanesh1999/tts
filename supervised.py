...
def supervised_tag():
    ...
    filepath = "./data/tamil_training.txt"
    language = "tamil"
    ...
    file_output = codecs.open("./output/" + language + "_tags.txt", 'w', 'utf-8')
    file_output.close()
    ...
    print("\nKindly check ./output/" + language + "_tags.txt file for POS tags.")
